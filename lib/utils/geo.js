...
var Geo = (function() {
  ...
  Geo.prototype.fromLatLngToCenterPixel = function fromLatLngToCenterPixel(
    ptLatLng
  ) {
  ...
  Geo.prototype.fromContainerPixelToLatLng = function fromContainerPixelToLatLng(
    ptXY
  ) {
    if (this.mapCanvasProjection_) {
  ...
  Geo.prototype.getBounds = function getBounds(margins, roundFactor) {
    ...
    if (
      ...
      var topLeftCorner = this.transform_.pointLocation(
        _pointGeometry2.default.convert({
          x: bndL - this.getWidth() / 2,
          y: bndT - this.getHeight() / 2,
        })
      );
      var bottomRightCorner = this.transform_.pointLocation(
        _pointGeometry2.default.convert({
