...
var GoogleMapMarkers = (function(_Component) {
  ...
  function GoogleMapMarkers(props) {
    ...
    _this._onChildClick = function(event) {
      if (_this.props.onChildClick) {
        if (_this.hoverChildProps_) {
          var hoverKey = _this.hoverKey_;
          var childProps = _this.hoverChildProps_;
          // click works only on hovered item
          _this.props.onChildClick(hoverKey, childProps, event);
        }
      }
    };
  ...
  GoogleMapMarkers.prototype.render = function render() {
    ...
    var markers = _react2.default.Children.map(
      ...
      function(child, childIndex) {
        ...
        var pt = _this2.props.insideMapPanes
          ? _this2.props.geoService.fromLatLngToDivPixel(latLng)
          : _this2.props.geoService.fromLatLngToCenterPixel(latLng);
        ...
        if (
          ...
          var sePt = _this2.props.insideMapPanes
            ? _this2.props.geoService.fromLatLngToDivPixel(seLatLng)
            : _this2.props.geoService.fromLatLngToCenterPixel(seLatLng);

          stylePtPos.width = sePt.x - pt.x;
          stylePtPos.height = sePt.y - pt.y;
        }

        var containerPt = _this2.props.geoService.fromLatLngToContainerPixel(
          latLng
        );
        ...
        return _react2.default.createElement(
          ...
          _react2.default.cloneElement(child, {
            ...
            $onMouseAllow: _this2._onMouseAllow,
            $prerender: _this2.props.prerender,
            $getMaps: _this2.props.getMaps,
            $getMap: _this2.props.getMap,
          })
        );
      }
    );
...
GoogleMapMarkers.propTypes = {
  ...
  getMaps: _propTypes2.default.func,
