...
function latLng2MetersPerDegree(_ref3) {
  ...
  var metersPerLatDegree = 111132.92 -
    559.82 * Math.cos(2 * phi) +
    1.175 * Math.cos(4 * phi) -
    0.0023 * Math.cos(6 * phi);
  var metersPerLngDegree = 111412.84 * Math.cos(phi) -
    93.5 * Math.cos(3 * phi) +
...
function meters2LatLngBounds(meters, _ref4) {
  var lat = _ref4.lat, lng = _ref4.lng;
...
function meters2WorldSize(meters, _ref5) {
  var lat = _ref5.lat, lng = _ref5.lng;
...
function fitBounds(_ref8, _ref9) {
  var nw = _ref8.nw, se = _ref8.se, ne = _ref8.ne, sw = _ref8.sw;
...
function meters2ScreenPixels(meters, _ref10, zoom) {
  var lat = _ref10.lat, lng = _ref10.lng;
...
function latLng2Tile(_ref12, zoom) {
  var lat = _ref12.lat, lng = _ref12.lng;
...
function getTilesIds(_ref13, zoom) {
  var from = _ref13.from, to = _ref13.to;
